...
export const programPoints = [
  {
    title: "The Verdict",
    description:
      "A revolutionary, safe, and non-habit-forming medication class for lasting weight loss, currently the most effective on the market.",
  },
  {
    title: "The Safety",
    description:
  ...
  },
  {
    ...
    description:
      "Semaglutide and Tirzepatide are advanced peptides that mimic gut hormones to reduce appetite and reset the body weight set point.",
  },
  {
    title: "Significant Results",
    description:
      "In clinical trials with diet and exercise, individuals lost an average of 15% body weight with weekly Semaglutide and 24.3% with weekly Tirzepatide.",
  },
]

export const whyMaxlife = [
